...
sns.lineplot(data=results, x='n_features', y='reward', hue='agent', palette=[scale_luminosity('palegoldenrod', 0.5), scale_luminosity('skyblue', 0.5)])
plt.legend([],[], frameon=False)
plt.ylabel('')
plt.xlabel('number of card features')
plt.title('average reward per step in cardsorting tasks of increasing size')
